...
var wtf_wikipedia=(function(){
    ...
    console.log(word_templates("({{convert|4|mi}})"))
    ...
    var main=function(wiki){
      ...
      matches.forEach(function(s){
        ...
        if(s.match(/\{\{(charmap|US|starbox|Quotation|Earthquake|service|CFB|footballbox|Pie|2TeamBracket|AFLGameDetailed|AFLGameFooter|yearbox|Grand|football|College|8TeamBracket|Motorsport|Rugbybox|NASCAR|Blacklisted-links|TennisEventInfo|CBB|F1|IceHockeybox|Fb_cl_footer|32TeamBracket|Curlingbox|Limited|PBA|basketballbox|linescore|WTCC|Year|MMAevent|MMAtitle|TennisEvents2|MotoGP_race_report|4Team2ElimBracket|16TeamBracket|3GameSeries|Fb|6Team2ElimA|NHLPlayoffs|6Team2ElimB|10TeamBracket|6Team2ElimC|64TeamBracket|Chembox|rquote|SGP|Round|3RoundBracket|hockeybox2|NRL|Ice|player4|SECBracket|6TeamBracket|FIBA|Baseball|4TeamBracket|4col|SCOTUSCase|Jctgap|BCint|Taxobox|Quote box|succession box|multiple|columns-list|Persondata|Panorama|stack|ordered list|Aircraft specs|Coin image|Drugbox|Album|track|Tracklist|NHL|Location|Crossings|MLBBioHon|Geobox|Chinese|Ordination|reflist|cite|Inligtingskas|sister|geographic|navboxes|listen|historical|citeweb|citenews|lien|clima|cita|Internetquelle|article|weather)[ \|:\n]/i)){
          wiki=wiki.replace(s,'')
        }
      })
